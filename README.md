...
Для начала на примере теста подтвердим сложности реализованных алгоритмов.
Для этого генерируется 10000 различных данных(данные - последовательности команд). На основе этого путем реализации [линейной регрессии](https://ru.wikipedia.org/wiki/Линейная_регрессия) вычисляется примерный вид выходной функции.
